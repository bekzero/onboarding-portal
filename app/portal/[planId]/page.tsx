...
export default async function PortalPlanPage({
  ...
  const nextStepPhase = bundle.phases.find((phase) => phase.id === nextTask.phaseId);
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {nextStepPhase ? <Badge>{nextStepPhase.title}</Badge> : null}
                  </div>
                ...
                <div className="min-w-full rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-4 lg:min-w-[260px]">
                  ...
                  <div className="mt-4 grid gap-3 text-sm text-slate-300">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-white">{nextStepPhase?.title ?? "Kickoff"}</span>
                    </div>
                  </div>
                </div>
              </div>
